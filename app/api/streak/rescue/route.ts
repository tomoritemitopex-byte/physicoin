...
// Orchestrator: no SQL here — delegated to ApiAdapter "streak" (see lib/adapters/features/streak.ts)
...
export async function GET(req: Request) { return safeHandle("streak", req); }
export async function POST(req: Request) { return safeHandle("streak", req); }
