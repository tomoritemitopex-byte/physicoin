...
export async function GET(req: Request) { return safeHandle("schools", req); }
export async function POST(req: Request) { return safeHandle("schools", req); }
export async function PATCH(req: Request) { return safeHandle("schools", req); }
