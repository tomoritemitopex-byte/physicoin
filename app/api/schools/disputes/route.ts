...
export async function GET(req: Request) { return safeHandle("school-disputes", req); }
export async function POST(req: Request) { return safeHandle("school-disputes", req); }
export async function PATCH(req: Request) { return safeHandle("school-disputes", req); }
