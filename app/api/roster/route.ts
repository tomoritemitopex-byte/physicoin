...
// Orchestrator: no SQL here — delegated to ApiAdapter "roster" (see lib/adapters/features/roster.ts)
...
export async function GET(req: Request) { return safeHandle("roster", req); }
export async function POST(req: Request) { return safeHandle("roster", req); }
