...
-- SEPARATE ledger from the lottery/daily mint (physi_mining_logs):
...
CREATE INDEX IF NOT EXISTS physi_truth_rewards_user_idx ON physi_truth_rewards (user_id, created_at DESC);
