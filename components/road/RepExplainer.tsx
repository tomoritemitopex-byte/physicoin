        ...
        <ul className="mt-4 grid gap-3">
          ...
          <li className="flex gap-2 rounded-xl border border-amber-400/20 bg-amber-500/10 px-3 py-3">
            ...
            <div>
              ...
              <p className="font-mono text-[11px] leading-4 text-slate-400">Gists are advisory, not official. Green tick = coursemates confirmed. Confirm exams via HOD/board. $PHY has no cash value.</p>
            </div>
          </li>
        </ul>
